...
export default {
  globalData: {
     ...
     */
    get_system_info() {
      let system_info = wx.getStorageSync(this.cache_system_info_key) || null;
    ...
    set_system_info() {
      ...
      wx.setStorage({
        key: this.cache_system_info_key,
        data: system_info
      });
      return system_info;
    },
     ...
     */
    get_user_cache_info() {
      let user = wx.getStorageSync(this.cache_user_info_key) || null;
    ...
    user_auth_login(object, method, auth_data) {
      ...
      wx.checkSession({
        success: function () {
          var openid = wx.getStorageSync(self.cache_user_login_key) || null;
    ...
    get_user_login_info(object, method, openid, auth_data) {
      // 邀请人参数
      var params = wx.getStorageSync(this.cache_launch_info_key) || null;
