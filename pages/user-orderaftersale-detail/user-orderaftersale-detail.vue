        ...
        <navigator :url="'/pages/goods-detail/goods-detail?goods_id=' + order_data.items.goods_id" hover-class="none">
          ...
          <view class="goods-base">
            ...
            <block v-if="order_data.items.spec != null">
              <view v-for="(spec, index) in order_data.items.spec" :key="index" class="goods-attribute cr-888">
          ...
          <view class="oh goods-price">
            ...
            <text v-if="order_data.items.original_price > 0" class="original-price">￥{{order_data.items.original_price}}</text>
  ...
  <view v-if="new_aftersale_data == null || new_aftersale_data.status == 5" class="spacing-mt">
    ...
    <view v-if="form_type != null" class="form-container spacing-mb oh">
      ...
      <view class="form-gorup bg-white">
        ...
        <input type="digit" @input="form_price_event" placeholder-class="cr-ccc" class="cr-666" placeholder="请输入退款金额" :value="form_price"></input>
      </view>

      <view class="form-gorup bg-white">
        <view class="form-gorup-title">退款说明<text class="form-group-tips-must">必填</text></view>
        <textarea @input="form_msg_event" placeholder-class="cr-ccc" class="cr-666" placeholder="退款说明 5~200 个字符之间" maxlength="200" auto-height="true" :value="form_msg"></textarea>
      </view>
      ...
      <view class="delivery-popup-content">
        <view class="form-container">
          <view class="form-gorup">
            ...
            <input type="text" @input="form_express_name_event" placeholder-class="cr-ccc" class="cr-666" placeholder="请输入快递名称" :value="form_express_name"></input>
          </view>
          <view class="form-gorup">
            <view class="form-gorup-title">快递单号<text class="form-group-tips-must">必填</text></view>
            <input type="text" @input="form_express_number_event" placeholder-class="cr-ccc" class="cr-666" placeholder="请输入快递单号" :value="form_express_number"></input>
          </view>
          <view class="form-gorup">
...
export default {
  ...
  onShow() {
    wx.setNavigationBarTitle({
      title: app.globalData.common_pages_title.user_orderaftersale_detail
    });
  },
